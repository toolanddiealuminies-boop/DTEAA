        ...
        <section className="p-5 border rounded-lg bg-[#F7F4EF]">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
             <div className="sm:col-span-2">
                ...
                <p className="text-md font-medium text-[#2E2E2E]">{`${userData.contact.address}, ${userData.contact.city}, ${userData.contact.state}, ${userData.contact.country} - ${userData.contact.pincode}`}</p>
            </div>
                ...
                <div className="space-y-4">
                    ...
                    {userData.experience.entrepreneur.map((exp) => (
                        <div key={exp.id} className="p-4 border-l-4 border-[#E7A700] rounded-r-lg bg-[#FFF9EE]">
                            ...
                            <p className="text-sm text-[#555555] mt-2">{`${exp.address}, ${exp.city}`}</p>
                        </div>
                    ))}
